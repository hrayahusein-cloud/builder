...
import 'package:sallihli/core/networking/api_error_model.dart';
  ...
  ApiErrorModel getFailure() {
    switch (this) {
      ...
      case DataSource.UNAUTORISED:
        return ApiErrorModel(error: ResponseMessage.UNAUTORISED);
      ...
      case DataSource.RECIEVE_TIMEOUT:
        return ApiErrorModel(error: ResponseMessage.RECIEVE_TIMEOUT);
