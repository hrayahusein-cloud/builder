...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ModelState<T>);
}
...
/// @nodoc
class $ModelStateCopyWith<T,$Res>  {
$ModelStateCopyWith(ModelState<T> _, $Res Function(ModelState<T>) __);
}


/// Adds pattern-matching-related methods to [ModelState].
extension ModelStatePatterns<T> on ModelState<T> {
...
class _Initial<T> implements ModelState<T> {
  const _Initial();
...
class _Loading<T> implements ModelState<T> {
  const _Loading();
...
class _Success<T> implements ModelState<T> {
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $ModelStateCopyWith<T, $Res> {
...
class _Error<T> implements ModelState<T> {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $ModelStateCopyWith<T, $Res> {
